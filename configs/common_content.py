            ...
            <aside class="sidebar">
                ...
                <div class="sidebar-section mobile-nav-section">
                    ...
                    <nav class="sidebar-nav">
                        <a href="#" class="sidebar-filter-link" data-filter="all">🏠 Home</a>
                        <a href="#" class="sidebar-filter-link" data-filter="Photos">📸 Photography</a>
                        <a href="#" class="sidebar-filter-link" data-filter="Creations">🎨 Creations</a>
                    </nav>
                </div>
